        ...
        <div className="flex flex-col gap-5 justify-start mt-[100px] ">
          {menutoBeRendered.map((item, key) => {
            return (
              <div
                key={key}
                className={`${activeRoute === item.path && "bg-blue-900 btn-disabled"
              ...
              >
                ...
                {!collapsed && (
                  ...
                  >
                    ...
                    <span className="absolute inset-0 border-2 border-blue-100 rounded-full"></span>
                  </span>
                )}
              </div>
            );
      ...
      <div className="w-full">
        <div className="bg-gray-800 flex flex-col justify-start items-center py-2">
          <img
            ...
            alt="logo"
            className="w-30 h-20 rounded-full cursor-pointer bg-white"
          />
